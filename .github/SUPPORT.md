# Getting help with HiClimR

Thanks for using HiClimR!
...
To be as efficient as possible, development of R packages tends to be very bursty, so you shouldn't worry if you don't get an immediate response.
