...
[**`HiClimR`**](http://cran.r-project.org/package=HiClimR) is licensed under `GPL-2 | GPL-3`. The code is modified by [Hamada S. Badr](http://blaustein.eps.jhu.edu/~hbadr1) from src/library/stats/R/hclust.R part of [R package](http://www.R-project.org) Copyright {exp:copyright:show start_year="1995" end_year="2015"} 1995-2015 The R Core Team.
